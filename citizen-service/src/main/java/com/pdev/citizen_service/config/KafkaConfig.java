...
/**
 * Kafka configuration for citizen-service.
...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, KycCompletedEvent> consumerFactory(ObjectMapper objectMapper) {
        Map<String, Object> configProps = new HashMap<>();
        configProps.put("bootstrap.servers", "localhost:9092");
        configProps.put("group.id", "citizen-service-group");
        ...
        DefaultKafkaConsumerFactory<String, KycCompletedEvent> factory = new DefaultKafkaConsumerFactory<>(configProps);
        factory.setValueDeserializerSupplier(() -> new JacksonDeserializer<>(objectMapper, KycCompletedEvent.class));
        return factory;
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, KycCompletedEvent> kafkaListenerContainerFactory(ConsumerFactory<String, KycCompletedEvent> consumerFactory) {
        ConcurrentKafkaListenerContainerFactory<String, KycCompletedEvent> factory =
